...
import com.ssp.maroqand.assignment3mvc.constant.enums.UserRole;
import com.ssp.maroqand.assignment3mvc.model.entity.*;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public boolean signUp(CustomerSignUp customerSignUp) {
        ...
        Role role= new Role();
        role.setRoleName(UserRole.USER.name());
        Set<Priviliges> set=new HashSet<>();
        roleRepository.save(role);
        for (String string: UserRole.USER.getGrantedAuthorities()){
